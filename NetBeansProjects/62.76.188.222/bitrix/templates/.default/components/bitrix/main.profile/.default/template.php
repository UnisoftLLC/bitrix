...
<h3 class="b-h3">Регистрационная информация</h3>
<div class="b-checkout">
<div class="b-field">
        <label class="b-field__label">Ваше имя:</label>
        <div class="b-field__wrapper clearfix">
                <div class="b-field__input"><input type="text"  name="NAME" maxlength="50" value="<?=$arResult["arUser"]["NAME"]?>"  class="b-text"></div>
...
<div class="b-field">
        ...
        <div class="b-field__wrapper clearfix">
                <div class="b-field__input"><input type="text"  name="EMAIL" maxlength="50" value="<? echo $arResult["arUser"]["EMAIL"]?>" class="b-text"></div>
                <div class="b-field__info"></div>
        </div>
</div>
<div class="b-field">
        <label class="b-field__label">Логин (мин. 3 символа): <span class="starrequired">*</span></label>
        <div class="b-field__wrapper clearfix">
...
<div class="b-field">
        <label class="b-field__label">Подтверждение нового пароля: </label>
        <div class="b-field__wrapper clearfix">
