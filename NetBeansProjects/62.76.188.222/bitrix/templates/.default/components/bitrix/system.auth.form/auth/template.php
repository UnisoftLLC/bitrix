...
<form method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
	...
	<table width="95%">
			<tr>
				...
				<input type="text" name="USER_LOGIN" maxlength="50" value="<?=$arResult["USER_LOGIN"]?>" size="17" class="b-text" /></td>
			</tr>
			<tr>
				<td colspan="2">
				<?=GetMessage("AUTH_PASSWORD")?>:<br />
				<input type="password" name="USER_PASSWORD" maxlength="50" size="17" class="b-text" /></td>
			</tr>
		<?
