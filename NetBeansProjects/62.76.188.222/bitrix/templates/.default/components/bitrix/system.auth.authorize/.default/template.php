...
<section class="b-detail">
    <div class="b-detail-content">
            <h3 class="b-h3">Пожалуйста, авторизируйтесь</h3>
            <?
	...
	<form name="form_auth" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
		...
		<?endforeach?> 
            <table class="b-subcribe__table">
                    ...
                    <tr>
                            <td><input type="text" class="b-text"></td>
                    </tr>
                    <tr>
                            <td>Пароль:</td>
                    </tr>
                    ...
                    <tr>
                            <td><label class="b-checkbox m-checkbox_gp_1"><input type="checkbox" value="1" name="checkbox_gp_1">Запомнить меня на этом компьютере</label></td>
                    </tr>
            </tbody></table>
            <button class="b-button">Войти</button>
            <p><a href="<?=$arResult["AUTH_FORGOT_PASSWORD_URL"]?>">Забыли свой пароль?</a></p>
            <p><a href="/register/">Регистрация</a><br>Если вы впервые на сайте, заполнпите, пожалуйста, регистрационную форму.</p>
    </form>
    </div>
</section>
